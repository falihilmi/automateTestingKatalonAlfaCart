...
public class ExcelExpected {

	public void cobaWriteExcel (int indexRow, String Strtest) throws IOException {
		...
		if (cell==null)
			//sheet.createRow(indexRow)
			for (int i=1; i<2; i++){
				sheet.getRow(indexRow).createCell(4).setCellValue(Strtest)
			}
